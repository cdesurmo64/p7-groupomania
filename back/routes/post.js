...
router.patch("/:id/text/update", auth.checkTokenValidity, auth.checkSpecialAuthorization, postCtrl.modifyPostText);
router.patch("/:id/picture/update", multer, auth.checkTokenValidity, auth.checkSpecialAuthorization, postCtrl.modifyPostPicture);
router.patch("/:id/picture/delete", auth.checkTokenValidity, auth.checkSpecialAuthorization, postCtrl.removePostPicture);
